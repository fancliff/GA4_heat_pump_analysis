...
while True:
    try:
        Tcond = float(input('Enter condenser temperature in Celsius: '))
        if Tcond < -50 or  Tcond > 100:
...
print(cp.PropsSI ('T','H',h4,'P',P4,fluid)-273.15)
print(cp.PropsSI ('T','P',P4,'Q',0,fluid)-273.15)
